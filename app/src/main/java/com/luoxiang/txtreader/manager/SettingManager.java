...
import com.luoxiang.txtreader.base.BaseActivity;
import com.luoxiang.txtreader.bean.support.BookMark;
...
public class SettingManager {
    ...
    public int getReadTheme() {
        if (SharedPreferencesUtil.getInstance().getBoolean(BaseActivity.ISNIGHT, false)) {
